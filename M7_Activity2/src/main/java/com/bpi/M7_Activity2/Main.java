...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // init list
        M7Exercise1 entry1 = new M7Exercise1(1L, "Aerion Targaryen", "House Targaryen", null);
       
        M7Exercise1 entry2 = new M7Exercise1(2L, "Lyonel Baratheon", "House Baratheon", null);

        M7Exercise1 entry3 = new M7Exercise1(3L, "Ser Duncan the Tall", "Hedge Knight", null);
